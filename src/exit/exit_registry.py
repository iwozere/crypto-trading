...
EXIT_PARAM_MAP = {
    ...
    "ma_crossover_exit": {"ma_period": {"type": "integer", "min": 10, "max": 50}},
    "time_based_exit": {"time_period": {"type": "integer", "min": 3, "max": 30}},
    "trailing_stop_exit": {"trail_pct": {"type": "real", "min": 0.01, "max": 0.05}},
}
